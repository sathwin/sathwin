...
export const projects: Project[] = [
  {
    ...
    desc: "Contract analysis platform built as ASU × Business School capstone. Serverless ingestion pipeline chains Textract OCR into Anthropic LLM via Bedrock. RAG comparison feature lets users ask plain-English questions across contracts.",
...
export const certifications: Award[] = [
  {
    ...
    desc: "AWS Certified Solutions Architect Associate - designing and deploying scalable systems on AWS",
    metric: "Feb 2026 · Amazon Web Services",
    color: "teal",
  },
  {
    icon: "cloud",
    title: "Azure Developer Associate (AZ-204)",
    desc: "Microsoft Certified: Azure Developer Associate - building cloud solutions and services on Azure",
    metric: "Dec 2025 · Microsoft",
    color: "teal",
  },
  {
    icon: "cloud",
    title: "AWS Cloud Practitioner",
    desc: "AWS Certified Cloud Practitioner - foundational understanding of AWS Cloud concepts",
    metric: "May 2025 · Amazon Web Services",
    color: "teal",
  },
  {
    icon: "code",
...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    company: "ASU IMPACT Lab · UC San Diego collab",
