  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        {/* Infra line */}
        <div className="text-xs font-mono text-text-secondary mb-3 leading-relaxed">{infra}</div>
...
export default function Projects() {
  return (
    <section id="projects" className="py-24 bg-navy relative overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-br from-[#ff6b35]/10 to-[#f7931e]/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-40 left-20 w-96 h-96 bg-gradient-to-br from-[#06ffa5]/10 to-[#ffd166]/5 rounded-full blur-3xl pointer-events-none" />
