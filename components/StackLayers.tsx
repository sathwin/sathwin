...
export default function StackLayers() {
  return (
    <section id="stack" className="py-24 bg-surface relative overflow-hidden">
      {/* Background gradient orbs */}
      <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-br from-[#ff6b35]/10 to-[#f7931e]/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-[#ffd166]/10 to-[#06ffa5]/5 rounded-full blur-3xl pointer-events-none" />
          ...
          {stackLayers.map((layer, index) => (
            ...
            >
              <div className="flex flex-col sm:flex-row">
                {/* Layer name */}
                <div className="w-full sm:w-[140px] px-4 py-4 sm:py-6 border-b sm:border-b-0 sm:border-r border-border">
